...
class NeuralNet(nn.Module):
	...
	def __init__(self,embedding_matrix,num_unit):
		...
		self.attention = Attention(num_unit*2, MAX_LEN)
		self.linear1 = nn.Linear(num_unit*4, num_unit*2)
		self.linear2 = nn.Linear(num_unit*4, num_unit*2)
		self.dropout1 = nn.Dropout(0.3)
		self.dropout2 = nn.Dropout(0.3)
		self.linear_out = nn.Linear(num_unit*2, 1)
		self.linear_aux_out = nn.Linear(num_unit*2, 5)
	...
	def forward(self, x):
		...
		# h_linear1 = self.dropout1(h_linear1)
		# h_linear2 = self.dropout2(h_linear2)
...
"""
Credit goes to https://www.kaggle.com/tanreinama/simple-lstm-using-identity-parameters-solution
"""
...
## Training and testing data transform to DataLoader
...
for epoch in range(EPOCHS):  # loop over the dataset multiple times
	...
	# 	inputs, labels = data
	# 	pred, _ = net(inputs)
	# 	loss_val = loss_fn(pred,labels[:,0])
